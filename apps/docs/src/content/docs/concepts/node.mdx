...
We have prepared the `eidos__extnode` table for storing extension nodes. You can combine it with Micro Block extensions to customize the display and interaction of nodes.
